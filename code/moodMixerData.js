...
export const MIXING_RECIPES = [
    ...
    { e1: 'anticipation', e2: 'joy', result: { id: 'optimism', name: 'Optimism', description: 'Looking forward to great things with a smile!', icon: 'assets/results/optimistic.svg', color: '#FFB300' } },
    ...
    { e1: 'anger', e2: 'joy', result: { id: 'pride', name: 'Pride', description: 'Feeling like a champion for doing something great!', icon: 'assets/results/pride.svg', color: '#FF8A65' } },
    { e1: 'anticipation', e2: 'trust', result: { id: 'hope', name: 'Hope', description: 'Waiting for something good to happen with a friend.', icon: 'assets/results/hope.svg', color: '#81C784' } },

    // Tertiary & Child-Specific
    ...
    { e1: 'anger', e2: 'disgust', result: { id: 'frustration', name: 'Frustration', description: 'When something is hard to do and you feel a bit cross.', icon: 'assets/results/frustration.svg', color: '#FF7043' } },
    { e1: 'surprise', e2: 'trust', result: { id: 'maze', name: 'Discovery', description: 'Finding something new and exciting with someone you trust.', icon: 'assets/results/maze.svg', color: '#4DB6AC' } },
    ...
    { e1: 'anger', e2: 'fear', result: { id: 'panic', name: 'Panic', description: 'When everything feels like it\'s moving too fast.', icon: 'assets/results/panic.svg', color: '#D81B60' } },
    { e1: 'anticipation', e2: 'joy', result: { id: 'excitement', name: 'Excitement', description: 'When you can\'t wait for something fun to start!', icon: 'assets/results/excitement.svg', color: '#FFEB3B' } },
    { e1: 'fear', e2: 'anticipation', result: { id: 'nervous', name: 'Nervous', description: 'That butterflies in your tummy feeling before a big day.', icon: 'assets/results/nervous.svg', color: '#9575CD' } },
    { e1: 'trust', e2: 'joy', result: { id: 'peace', name: 'Peace', description: 'The calm, happy feeling of being safe and loved.', icon: 'assets/results/peace.svg', color: '#81C784' } }
];
